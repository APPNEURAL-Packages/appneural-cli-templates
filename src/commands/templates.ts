...
export function registerTemplateCommands(program: Command): void {
  ...
  templates
    ...
    .action(() =>
      withTelemetry("templates:list", async () => {
  ...
  templates
    ...
    .action(() =>
      withTelemetry("templates:sync", async () => {
  ...
  templates
    ...
    .action((template: string, project: string) =>
      withTelemetry("templates:new", async () => {
        ...
        await withSpinner("Generating APPNEURAL template", async () =>
          createProjectFromTemplate(template, project)
        );
